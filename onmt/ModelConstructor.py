...
import onmt.Models
import onmt.modules
from onmt.Models import NMTModel, NMTModelGCN, MeanEncoder, RNNEncoder, \
                        StdRNNDecoder, InputFeedRNNDecoder, GCNEncoder
...
def make_morph_embeddings(opt, word_dict, feature_dicts, for_encoder=True):
    """
    Make an Embeddings instance.
    Args:
        opt: the option in current environment.
    ...
    """
    if for_encoder:
        embedding_dim = opt.morph_vec_size
