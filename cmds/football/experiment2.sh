...
java -jar ../../eval_tools/tercom-master/tercom-0.10.0.jar -h ../../data/data-football/delex_attr_postfix_/relexpredictions_$SNAME-ter.txt -r ../../data/data-football/delex_attr_postfix_/$PARAMS-all-notdelex-refs-ter.txt > out_ter_delex_attr_postfix_$PARAMS.txt

# # # #METEOR
java -Xmx2G -jar ../../eval_tools/meteor-master/meteor-1.6.jar ../../data/data-football/delex_attr_postfix_/relexpredictions_$NAME ../../data/data-football/delex_attr_postfix_/$PARAMS-all-notdelex-refs-meteor.txt -r 8 -l de -norm > out_meteor_delex_attr_postfix_$PARAMS.txt
