...
#ctxe
python3 ../../football_processing/ctx_eval.py -p ../../data/data-football/${type}_/delexicalized_predictions_test_${num}.txt -r ../../data/data-football/${type}_/test-data-football-gcn-${type}-tgt.txt -o ../../data/data-football/${type}_/ctx_eval_${num}.txt -f ../../data/data-football/${type}_/delexicalized_predictions_test_fake_${num}.txt -c ../../data/data-football/${type}_/test-data-football-gcn-${type}-context.txt -x ../../data/data-football/${type}_/test_fake-data-football-gcn-${type}-context.txt
