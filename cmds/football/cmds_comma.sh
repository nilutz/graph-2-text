...
python3 ../../train.py -data ../../data/football_${type}_1 -save_model ../../data/football_${type}_${num}_ctx -rnn_size 256 -word_vec_size 256 -layers 1 -epochs 30 -optim adam -learning_rate 0.001 -encoder_type gcn -gcn_num_inputs 256 -gcn_num_units 256 -gcn_in_arcs -gcn_out_arcs -gcn_num_layers 4 -gcn_num_labels 5 -context -tensorboard -gpuid 0 -model_name football_${type}_${num}_ctx -gcn_residual residual -seed ${num}
...
#relex
python ../../football_processing/relex.py -t ../../data/data-football/${type}_ -p delexicalized_predictions_test_${num}.txt -r test-data-football-gcn-delex_comma.relex
...
#BLEU
sh ../../football_processing/calculate_bleu.sh ../../data/data-football/${type}_/test-data-football-gcn-delex_comma.reference  ../../data/data-football/${type}_/relexicalised_predictions_test_${num}.txt > out_bleu_${type}_${num}.txt
...
#CTXE
python3 ../../football_processing/ctx_eval.py -p ../../data/data-football/${type}_/relexicalised_predictions_test_${num}.txt -r ../../data/data-football/${type}_/test-data-football-gcn-delex_comma.reference -o ../../data/data-football/${type}/ctx_eval_${type}_${num}.txt -f ../../data/data-football/${type}_/relexicalised_predictions_fake_${num}.txt -c ../../data/data-football/${type}_/test-data-football-gcn-delex_comma-context.txt -x ../../data/data-football/${type}_/test_fake-data-football-gcn-delex_comma-context.txt
