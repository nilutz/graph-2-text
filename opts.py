...
def model_opts(parser):
    ...
    group.add_argument('-morph_vec_size', type=int, default=500,
                       help='Embedding size for morphologucal features.')
    ...
    group.add_argument('-encoder_type', type=str, default='rnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'gcn'],
                       help="""Type of encoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|brnn|mean|transformer|cnn|gcn].""")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_label', required=False,
                       help="Path to the training source data")
    group.add_argument('-train_node1', required=False,
                       help="Path to the training source data")
    group.add_argument('-train_node2', required=False,
                       help="Path to the training source data")
    ...
    group.add_argument('-valid_label', required=False,
                       help="Path to the training source data")
    group.add_argument('-valid_node1', required=False,
                       help="Path to the training source data")
    group.add_argument('-valid_node2', required=False,
                       help="Path to the training source data")
...
def gcn_opts(parser):
    ...
    group.add_argument('-gcn_num_layers', type=int, default=1,
                       help='Number of gcn layers')
    group.add_argument('-gcn_in_arcs', action="store_true",
                       help='Use incoming edges of the gcn layer')
    group.add_argument('-gcn_out_arcs', action="store_true",
